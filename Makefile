...
add-collections:
	pypgstac --dsn postgres://username:password@database:5432/postgis load collections documents/*.json

# This is running locally too
add-items:
	cat IMOS_Argo_South_Pacific-items/*_stac-item.json | jq -c > temp.json \
